...
Details regarding security updates, feature updates, and management guidance for Microsoft 365 Apps on Windows 10 after its end of support will be added to this article as more information becomes availalble.
...
- For end of support dates for Office and Microsoft 365 Apps on various versions of Windows, see the [Office and Windows configuration support matrix](https://aka.ms/windows-office-support-matrix).
