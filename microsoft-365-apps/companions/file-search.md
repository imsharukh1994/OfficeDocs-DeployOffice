...
:::image type="content" source="media/file-search.png" alt-text="Screenshot showing the Windows desktop with the File Search interface open, displaying search results for documents and files related to architecture.":::
